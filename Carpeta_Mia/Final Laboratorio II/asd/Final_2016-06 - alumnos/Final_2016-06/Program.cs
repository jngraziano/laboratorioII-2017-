...
namespace Final_2016_06
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Me llamo Graziano, Julian y curso en la División 2º D";
            ...
            try
            {
                Estacionamiento lecturaEstacionamiento = new Estacionamiento(10);
                estacionamiento.leer("estacionamiento.xml", lecturaEstacionamiento);
            ...
            try
            {
                Automovil lecturaAuto = new Automovil(Vehiculo.EMarca.BMW, "AAA-456", ConsoleColor.Blue);
                a1.leer("auto.bin", lecturaAuto);
                a1 = lecturaAuto;
