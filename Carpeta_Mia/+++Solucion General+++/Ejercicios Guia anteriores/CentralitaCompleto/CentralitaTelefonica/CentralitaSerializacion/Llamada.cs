...
namespace CentralitaSerializacion
{
    public abstract class Llamada
    {
        ...
        public virtual bool Serializacion()
        {
            XmlTextWriter xmlT = new XmlTextWriter(@"F:\Facultad\Programacion II (C#) 2016\+++Solucion General+++\Ejercicios Guia anteriores\CentralitaCompleto\CentralitaTelefonica\XmlSerializacionLlamada.xml", Encoding.UTF8);
            XmlSerializer xmlS = new XmlSerializer(typeof(Llamada));
