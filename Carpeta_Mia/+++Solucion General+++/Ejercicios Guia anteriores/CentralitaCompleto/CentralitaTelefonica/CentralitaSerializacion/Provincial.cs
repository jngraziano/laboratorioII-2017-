...
namespace CentralitaSerializacion
{
    public class Provincial : Llamada
    {
        ...
        public Provincial(Franja miFranja, Llamada unallamada):this()
        {
        ...
        public override bool Serializacion()
        {
            XmlTextWriter xmlT = new XmlTextWriter(@"F:\Facultad\Programacion II (C#) 2016\+++Solucion General+++\Ejercicios Guia anteriores\CentralitaCompleto\CentralitaTelefonica\XmlSerializacionProvincial.xml", Encoding.UTF8);
            XmlSerializer xmlS = new XmlSerializer(typeof(Local));
