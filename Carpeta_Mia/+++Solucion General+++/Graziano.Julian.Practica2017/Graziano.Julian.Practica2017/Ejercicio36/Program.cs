...
namespace Ejercicio36
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Container ContenerdorUno = new Container(2, "Skanka"); Container ContenerdorDos = new Container(3, "Skanka"); 
            ...
            if (!ContenerdorDos.Agregar(ProductoCuatro)) { Console.WriteLine("No se pudo"); }
            ...
            foreach (Producto item in listaProducto) { item.mostrar(); }
            Console.ReadLine();
        }
    }
}
